...
public class GroupController {
    ...
    public ResponseEntity<?> getMyGroups(@RequestBody GroupRequest getGroupsRequest) {
    ...
    public ResponseEntity<?> getGroupDetails(@PathVariable Long id,
        @RequestBody GroupRequest getGroupsRequest) {
    ...
    public ResponseEntity<?> getGroupDetail(@PathVariable Long id, @RequestBody
    GroupRequest request) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> deleteGroup(@PathVariable Long id, @RequestBody GroupRequest request) {
