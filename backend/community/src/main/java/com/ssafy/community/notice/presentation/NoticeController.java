...
public class NoticeController {
    ...
    public ResponseEntity<List<NoticeListResponse>> getNoticeList(@PathVariable int groupId) {
        List<NoticeListResponse> noticeList = noticeService.getNoticeList(groupId);
